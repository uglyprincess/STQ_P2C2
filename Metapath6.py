...
class metapath_6():
    ...
    def metapath_6_req_1(self, mean_time):
    ...
    def metapath_6_req_2(self, mean_time):
    ...
    def metapath_6_req_3(self, mean_time):
    ...
    def metapath_6_req_4(self, mean_time):
    ...
    def metapath_6_req_5(self, mean_time):
    ...
    def metapath_6_req_6(self, mean_time):
    ...
    def metapath_6_req_7(self, mean_time):
    ...
    def metapath_6_req_8(self, mean_time):
...
if __name__ == "__main__":
    ...
    # RQ1
    print("Requirement 1 for Metapath 6:\n")
    req1 = query.metapath_6_req_1(rejection_mean_time)  
    # Calling HRanking Function
    HRank.perform_asymmetric(req1)
    print()
    
    # RQ2
    print("Requirement 2 for Metapath 6:\n")    
    req2 = query.metapath_6_req_2(rejection_mean_time)
    # Calling HRanking Function
    HRank.perform_asymmetric(req2)
    print()

    # RQ3
    print("Requirement 3 for Metapath 6:\n")    
    req3 = query.metapath_6_req_3(all_mean_time)
    # Calling HRanking Function
    HRank.perform_asymmetric(req3)
    print()
    
    # RQ4
    print("Requirement 4 for Metapath 6:\n")    
    req4 = query.metapath_6_req_4(all_mean_time)
    # Calling HRanking Function
    HRank.perform_asymmetric(req4)
    print()

    # RQ5
    print("Requirement 5 for Metapath 6:\n")    
    req5 = query.metapath_6_req_5(acceptance_mean_time)
    # Calling HRanking Function
    HRank.perform_asymmetric(req5)
    print()
    
    # RQ6
    print("Requirement 6 for Metapath 6:\n")    
    req6 = query.metapath_6_req_6(acceptance_mean_time)
    # Calling HRanking Function
    HRank.perform_asymmetric(req6)
    print()

    # RQ7
    print("Requirement 7 for Metapath 6:\n")
    req7 = query.metapath_6_req_7(rejection_mean_time)  
    # Calling HRanking Function
    HRank.perform_asymmetric(req7)
    print()
    
    # RQ8
    print("Requirement 8 for Metapath 6:\n")    
    req8 = query.metapath_6_req_8(rejection_mean_time)
    # Calling HRanking Function
